...
public class CustomerAccountMgmtAPI {
	 ...
	 * Check Redis health
	 */
	@Get(value = "/healthcheck-redis")
	@Produces(MediaType.APPLICATION_JSON)
	public HttpResponse<ServiceResponse> healthCheckRedis() {
		
		RedisCommands<String, String> commands = connection.sync();
		commands.set("Redis_Health", "Redis connection is UP");
		
		
		ServiceResponse ServiceResponse = new ServiceResponse();
		ServiceResponse.setMessage(commands.get("Redis_Health"));
